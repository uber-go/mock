...
// Source: go.uber.org/mock/mockgen/internal/tests/import_mode (interfaces: Food,Eater,Animal,Human,Primate,Car,Driver,UrbanResident,Farmer,PromotionCampaign)
//
// Generated by this command:
//
//	mockgen -typed -package=mock -destination=mock/interfaces.go . Food,Eater,Animal,Human,Primate,Car,Driver,UrbanResident,Farmer,PromotionCampaign
//
...
import (
	...
	cars "go.uber.org/mock/mockgen/internal/tests/import_mode/cars"
	fuel "go.uber.org/mock/mockgen/internal/tests/import_mode/fuel"
)
...
func (m *MockEater) Eat(foods ...import_mode.Food) {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range foods {
...
// Do rewrite *gomock.Call.Do
func (c *MockEaterEatCall) Do(f func(...import_mode.Food)) *MockEaterEatCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockEaterEatCall) DoAndReturn(f func(...import_mode.Food)) *MockEaterEatCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// Eat mocks base method.
func (m *MockAnimal) Eat(foods ...import_mode.Food) {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range foods {
		varargs = append(varargs, a)
...
// Do rewrite *gomock.Call.Do
func (c *MockAnimalEatCall) Do(f func(...import_mode.Food)) *MockAnimalEatCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockAnimalEatCall) DoAndReturn(f func(...import_mode.Food)) *MockAnimalEatCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// Eat mocks base method.
func (m *MockPrimate) Eat(foods ...import_mode.Food) {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range foods {
		varargs = append(varargs, a)
...
// Do rewrite *gomock.Call.Do
func (c *MockPrimateEatCall) Do(f func(...import_mode.Food)) *MockPrimateEatCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockPrimateEatCall) DoAndReturn(f func(...import_mode.Food)) *MockPrimateEatCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
type MockDriverMockRecorder[FuelType fuel.Fuel, CarType import_mode.Car[FuelType]] struct {
	mock *MockDriver[FuelType, CarType]
}

// NewMockDriver creates a new mock instance.
func NewMockDriver[FuelType fuel.Fuel, CarType import_mode.Car[FuelType]](ctrl *gomock.Controller) *MockDriver[FuelType, CarType] {
...
type MockDriverDriveCall[FuelType fuel.Fuel, CarType import_mode.Car[FuelType]] struct {
	*gomock.Call
}
...
type MockDriverWroomCall[FuelType fuel.Fuel, CarType import_mode.Car[FuelType]] struct {
	*gomock.Call
}
...
func (m *MockUrbanResident) Do(work *import_mode.Work) error {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockUrbanResidentDoCall) Do(f func(*import_mode.Work) error) *MockUrbanResidentDoCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockUrbanResidentDoCall) DoAndReturn(f func(*import_mode.Work) error) *MockUrbanResidentDoCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// Eat mocks base method.
func (m *MockUrbanResident) Eat(foods ...import_mode.Food) {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range foods {
		varargs = append(varargs, a)
...
// Do rewrite *gomock.Call.Do
func (c *MockUrbanResidentEatCall) Do(f func(...import_mode.Food)) *MockUrbanResidentEatCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockUrbanResidentEatCall) DoAndReturn(f func(...import_mode.Food)) *MockUrbanResidentEatCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// Do mocks base method.
func (m *MockFarmer) Do(work *import_mode.Work) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Do", work)
	ret0, _ := ret[0].(error)
	return ret0
...
// Do rewrite *gomock.Call.Do
func (c *MockFarmerDoCall) Do(f func(*import_mode.Work) error) *MockFarmerDoCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockFarmerDoCall) DoAndReturn(f func(*import_mode.Work) error) *MockFarmerDoCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// Eat mocks base method.
func (m *MockFarmer) Eat(foods ...import_mode.Food) {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range foods {
		varargs = append(varargs, a)
...
// Do rewrite *gomock.Call.Do
func (c *MockFarmerEatCall) Do(f func(...import_mode.Food)) *MockFarmerEatCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockFarmerEatCall) DoAndReturn(f func(...import_mode.Food)) *MockFarmerEatCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// MockPromotionCampaign is a mock of PromotionCampaign interface.
type MockPromotionCampaign struct {
	ctrl     *gomock.Controller
	recorder *MockPromotionCampaignMockRecorder
}

// MockPromotionCampaignMockRecorder is the mock recorder for MockPromotionCampaign.
type MockPromotionCampaignMockRecorder struct {
	mock *MockPromotionCampaign
}

// NewMockPromotionCampaign creates a new mock instance.
func NewMockPromotionCampaign(ctrl *gomock.Controller) *MockPromotionCampaign {
	mock := &MockPromotionCampaign{ctrl: ctrl}
	mock.recorder = &MockPromotionCampaignMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPromotionCampaign) EXPECT() *MockPromotionCampaignMockRecorder {
	return m.recorder
}

// ISGOMOCK indicates that this struct is a gomock mock.
func (m *MockPromotionCampaign) ISGOMOCK() struct{} {
	return struct{}{}
}

// YouMustBuyOurCar mocks base method.
func (m *MockPromotionCampaign) YouMustBuyOurCar() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "YouMustBuyOurCar")
}

// YouMustBuyOurCar indicates an expected call of YouMustBuyOurCar.
func (mr *MockPromotionCampaignMockRecorder) YouMustBuyOurCar() *MockPromotionCampaignYouMustBuyOurCarCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "YouMustBuyOurCar", reflect.TypeOf((*MockPromotionCampaign)(nil).YouMustBuyOurCar))
	return &MockPromotionCampaignYouMustBuyOurCarCall{Call: call}
}

// MockPromotionCampaignYouMustBuyOurCarCall wrap *gomock.Call
type MockPromotionCampaignYouMustBuyOurCarCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockPromotionCampaignYouMustBuyOurCarCall) Return() *MockPromotionCampaignYouMustBuyOurCarCall {
	c.Call = c.Call.Return()
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockPromotionCampaignYouMustBuyOurCarCall) Do(f func()) *MockPromotionCampaignYouMustBuyOurCarCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockPromotionCampaignYouMustBuyOurCarCall) DoAndReturn(f func()) *MockPromotionCampaignYouMustBuyOurCarCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
