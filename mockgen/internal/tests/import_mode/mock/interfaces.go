...
// Source: go.uber.org/mock/mockgen/internal/tests/import_mode (interfaces: Food,Eater,Animal,Human,Primate,Car,Driver,UrbanResident,Farmer)
//
// Generated by this command:
//
//	mockgen -typed -package=mock -destination=mock/interfaces.go . Food,Eater,Animal,Human,Primate,Car,Driver,UrbanResident,Farmer
//
