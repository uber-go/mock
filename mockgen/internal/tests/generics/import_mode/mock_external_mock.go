...
// Source: go.uber.org/mock/mockgen/internal/tests/generics (interfaces: ExternalConstraint,EmbeddingIface,Generator,Group)
//
// Generated by this command:
//
//	mockgen --destination=import_mode/mock_external_mock.go -package=import_mode . ExternalConstraint,EmbeddingIface,Generator,Group
//
