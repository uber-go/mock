...
//
//	/Users/tulzke/Library/Caches/JetBrains/GoLand2023.1/tmp/GoLand/___go_build_go_uber_org_mock_mockgen -source=./internal/tests/exclude/interfaces.go -destination=./internal/tests/exclude/mock.go -package=exclude -exclude=IgnoreMe,IgnoreMe2
//
