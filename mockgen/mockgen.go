...
var (
	...
	writeInvocationComment = flag.Bool("write_invocation_comment", true, "Writes the specific command invocation used to generate this file into the comment header if true.")
